...
from rtfw.Constants import ViewKind, ViewScale, ViewZoomKind, Languages
from rtfw.PropertySets import (ParagraphPropertySet,
                               TabPropertySet,
                               ShadingPropertySet,
                               BorderPropertySet)
from rtfw.Elements import (Table, Cell, Section, Paragraph, RawCode, Image,
                           Text, Inline, TAB, LINE)
...
class Renderer :
    ...
    def _WriteElements( self, elements ) :
        ...
        for element in elements :
            ...
            elif clss == UnicodeType :
                self.WriteParagraphElement( Paragraph( element.encode('rtfunicode') ) )
    ...
    def WriteParagraphElement( self, paragraph_elem, tag_prefix='', tag_suffix=r'\par', opening='{', closing='}' ) :
        ...
        for element in paragraph_elem :
            ...
            if isinstance( element, StringType ) :
                ...
                self._write( element.encode('rtfunicode') )
                ...
                raise Exception( 'Don\'t know how to handle %s (%s)' % (element, element.__class__))
    ...
    def WriteTextElement( self, text_elem ) :
        ...
        elif isinstance( text_elem.Data, UnicodeType ) :
            self._write( text_elem.Data.encode('rtfunicode') or '' )
            ...
            for cell in cells :
                if len( cell ) :
                    ...
                    for element_idx, element in enumerate( cell ) :
                        ...
                        if isinstance( element, UnicodeType ) :
                            element = Paragraph( element.encode('rtfunicode') )
