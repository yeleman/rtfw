...
from types import IntType, FloatType, LongType, StringType, UnicodeType
from copy import deepcopy
from binascii import hexlify

import magic

from rtfw.Constants import Languages, ViewKind
from rtfw.Styles import TextStyle, ParagraphStyle
from rtfw.PropertySets import (Colours, Colour, Fonts, Font, Papers, Paper,
                               AttributedList,
                               TextPropertySet,
                               MarginsPropertySet,
                               ParagraphPropertySet,
                               TabPropertySet,
                               TabPS, TextPS, ShadingPS,
                               ParagraphPS, FramePS, MarginsPS)
...
_PNG_MIMETYPE = 'image/png'
def _get_png_dimensions( data ) :
    if magic.from_buffer(data, mime=True) != _PNG_MIMETYPE:
...
class Cell( list ) :
    ...
    def __init__( self, *params, **kwargs ) :
        ...
        for param in params :
            ...
            elif isinstance( param, UnicodeType  ) : self.append    ( param )
